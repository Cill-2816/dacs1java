...
public class MenuData {
    public static List<MenuItem> getSampleMenu() {
        return Arrays.asList(
            ...
            new MenuItem("Pasta Alfredo", "Creamy Alfredo sauce with fettuccine.", "$14.75", "image/food7.png"),
            new MenuItem("Tuna Sandwich", "Toasted sandwich with tuna and veggies.", "$9.85", "image/food8.png"),
            new MenuItem("Vegan Bowl", "A healthy mix of grains, veggies and tofu.", "$12.30", "image/food9.png")
        );
    }
}
